...
namespace ASC.Web.Data
{
    ...
    public class NavigationCacheOperations : INavigationCacheOperations
    {
        ...
        private readonly string NavigationCachName = "NavigationCache";
        ...
        {
            await _cache.SetStringAsync(NavigationCachName, File.ReadAllText("Navigation/Navigation.json"));

        }

        public async Task<NavigationMenu> GetNavigationCacheAsync()
        {
            return JsonConvert.DeserializeObject<NavigationMenu>(await _cache.GetStringAsync(NavigationCachName));
        }
    }
}
