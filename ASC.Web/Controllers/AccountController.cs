    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var isActive = bool.Parse(user.Claims.SingleOrDefault(p => p.ClaimType == "IsActive")?.ClaimValue);
                if (!isActive)
                {
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.UserName, Email = email, EmailConfirmed = true };
        ...
        public async Task<IActionResult> InitiateResetPassword()
        {
            ...
            //slanje maila
            await _emailSender.SendEmailAsync(userEmail, "Reset Password", message);
            return View("ForgotPasswordConfirmation");
        }
