...
namespace ASC.DataAccess
{
    public class UnitOfWork :IUnitOfWork
    {
        ...
        public UnitOfWork(string connesctionString)
        {
            ConnectionString = connesctionString;
        ...
        public void CommitTransaction() => complete = true;
        ...
        private void RollbackTransaction()
        {
            ...
            {
                Task<Action> undoAction = RollbackActions.Dequeue();
                undoAction.Result();
            }
        }
